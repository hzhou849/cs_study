...
# 1a - modify to persistent Latch mode and keep  and reset mode.
# 2. clear gpio states on on exit (using 2nd window check function) see fangui code
...
# ==========================================================================================
	...
	def getGpioState(self):
			...
			self.gpio0_entry.config(state=NORMAL) #check if this works or place back in for loop
		for x in gpioList:
