...
1. Download the binary fan_gui_binary_release.tar.gz file from agile to an Ubuntu 14.04 (or higher)
   test PC.

2. extract and run 'start_gpio' by typing:
	'cd <path to scripts>/./start_gpio'
